...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230223-17_AB01-Scarlet-circuit1_seg4.csv'
    vicon_filename = 'Vicon_AB01-Scarlet_circuit1_seg4_processed.csv'
    export_filename = 'exoboot_' + vicon_filename

    time_vicon_offset = -0.879 - 0.0458
