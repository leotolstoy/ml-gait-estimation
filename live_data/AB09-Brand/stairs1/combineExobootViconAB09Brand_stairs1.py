...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230214-21_AB09-Brand-stairs1.csv'
    vicon_filename = 'Vicon_AB09-Brand_stairs1_processed.csv'
    export_filename = 'exoboot_Vicon_AB09-Brand_stairs1.csv'

    time_vicon_offset = -4.176 - 0.011
