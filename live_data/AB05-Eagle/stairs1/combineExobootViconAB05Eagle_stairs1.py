...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230214-21_AB05-Eagle-stairs1.csv'
    vicon_filename = 'Vicon_AB05-Eagle_stairs1_processed.csv'
    export_filename = 'exoboot_Vicon_AB05-Eagle_stairs1.csv'

    time_vicon_offset = -0.486-1.623
