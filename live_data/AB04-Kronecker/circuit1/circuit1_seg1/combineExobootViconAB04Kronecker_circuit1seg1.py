...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230222-22_AB04-Kronecker_circuit1_seg1.csv'
    vicon_filename = 'Vicon_AB04-Kronecker_circuit1_seg1_processed.csv'
    export_filename = 'exoboot_' + vicon_filename

    time_vicon_offset = -1.612 + 0.026
