...
def main():
    ...
    # filename = 'pilot_data/AB05-Eagle/20230206-19_AB05-Eagle-pilotwalkingcircuit2_seg2.csv'
    # filename = 'pilot_data/AB05-Eagle/20230206-19_AB05_Eagle_stairs1.csv'
    
    # filename = 'pilot_data/AB05-Eagle/exoboot_Vicon_AB05-Eagle_pilotwalkingcircuitseg1.csv'
    # filename = 'pilot_data/AB05-Eagle/exoboot_Vicon_AB05-Eagle_pilotwalkingcircuitseg2.csv'
    # filename = 'pilot_data/AB05-Eagle/exoboot_Vicon_AB05-Eagle_pilotwalkingstairs1.csv'
    
    # filename = 'pilot_data/AB05-Eagle/pilotcircuit2seg1/exoboot_Vicon_Pilot-AB05-Eagle_Pilot_circuit_2_seg1_processed.csv'
    # filename = 'pilot_data/AB05-Eagle/pilotcircuit2seg2/exoboot_Vicon_Pilot-AB05-Eagle_Pilot_circuit2_seg2_processed.csv'
    # filename = 'live_data/AB05-Eagle/stairs1/exoboot_Vicon_AB05-Eagle_stairs1.csv'
    
    # filename = 'live_data/AB04-Kronecker/stairs1/exoboot_Vicon_AB04-Kronecker_stairs1.csv'
    filename = 'live_data/AB04-Kronecker/circuit3/circuit3_seg2/exoboot_Vicon_AB04-Kronecker_circuit3_seg2_processed.csv'

    # filename = 'live_data/AB09-Brand/circuit2/circuit2_seg1/exoboot_Vicon_AB09-Brand_circuit2_seg1_processed.csv'
    # filename = 'live_data/AB09-Brand/circuit2/circuit2_seg2/exoboot_Vicon_AB09-Brand_circuit2_seg2_processed.csv'
    # filename = 'live_data/AB09-Brand/circuit3/circuit3_seg1/exoboot_Vicon_AB09-Brand_circuit3_seg1_processed.csv'
    # filename = 'live_data/AB09-Brand/circuit3/circuit3_seg4/exoboot_Vicon_AB09-Brand_circuit3_seg4_processed.csv'
