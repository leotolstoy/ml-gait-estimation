...
def main():
    ...
    # data = np.loadtxt("pilot_data/AB12-Brake/20230206-21_AB12-Brake-stairspilot1.csv", delimiter=',')
    # data = np.loadtxt("pilot_data/AB05-Eagle/pilotwalkingcircuitseg1/20230206-19_AB05-Eagle-pilotwalkingcircuit2_seg1.csv", delimiter=',')
    # data = np.loadtxt("pilot_data/AB09-Brand/stairs1/20230214-21_AB09-Brand-stairs1.csv", delimiter=',')
    # data = np.loadtxt("pilot_data/AB05-Eagle/stairs1/20230214-21_AB05-Eagle-stairs1.csv", delimiter=',')
    # data = np.loadtxt("pilot_data/AB05-Eagle/pilotcircuit2seg1/20230214-21_AB05-Eagle-circuit2_seg1.csv", delimiter=',')
    # data = np.loadtxt("pilot_data/AB05-Eagle/pilotcircuit2seg2/20230214-21_AB05-Eagle-circuit2_seg2.csv", delimiter=',')
    # data = np.loadtxt("pilot_data/AB04-Kronecker/circuit-seg1/20230215-16_AB04-Kronecker-pilotcircuitseg1.csv", delimiter=',')
    # data = np.loadtxt("live_data/AB02-Parallel/stairs1/20230220-18_AB02-Parallel-stairs1.csv", delimiter=',')
    # data = np.loadtxt("live_data/AB07-Futon/stairs1/20230220-20_AB07-Futon-stairs1.csv", delimiter=',')
    # data = np.loadtxt("live_data/AB09-Brand/circuit6_highTorque/circuit6_seg1/20230221-18_AB09-Brand-circuit6_highTorque_seg1.csv", delimiter=',')
    # data = np.loadtxt("live_data/AB03-Hammer/stairs1/20230221-19_AB03-Hammer-stairs1.csv", delimiter=',')
    # data = np.loadtxt("live_data/AB10-DaVinci/stairs1/20230222-20_AB10-DaVinci_stairs1.csv", delimiter=',')
    # data = np.loadtxt("live_data/AB04-Kronecker/circuit2/circuit2_seg3/20230222-22_AB04-Kronecker_circuit2_seg3.csv", delimiter=',')
    # data = np.loadtxt("live_data/AB01-Scarlet/circuit3/circuit3_seg3/20230223-17_AB01-Scarlet-circuit3_seg3.csv", delimiter=',')
    # data = np.loadtxt("live_data/AB07-Futon/circuit3/circuit3_seg2/20230223-18_AB07-Futon_circuit3_seg2.csv", delimiter=',')
    # data = np.loadtxt("live_data/AB02-Parallel/circuit1/circuit1_seg1/20230227-19_AB02-Parallel_circuit1_seg1.csv", delimiter=',')
    data = np.loadtxt("live_data/AB11-Frihet/circuit1/circuit1_seg3/20230307-17_AB11-Frihet_circuit1_seg3.csv", delimiter=',')
