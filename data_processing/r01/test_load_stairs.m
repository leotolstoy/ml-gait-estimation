...
%     stair_fieldnames = {'s25dg_03'}
%     stair_fieldnames = {'s30dg_02'}
%     stair_fieldnames = {'s20dg_01'}
%     stair_fieldnames = {'s35dg_08'}
%     stair_fieldnames = {'s25dg_04'}
%     stair_fieldnames = {'s25dg_08'}
...
%             treadmill_speed = [treadmill_speed(1);treadmill_speed];
            ...
            [processed_struct_L] = analyze_stair_kinematics(L_foot_angle_data,L_shank_angle_data,...
                ...
                L_HS,...
                treadmill_speed, treadmill_incline, stride_count_master, L_stair_events, LEFT_LEG_NUM, SAMPLE_RATE_VICON_NOMINAL);
            ...
            [processed_struct_R] = analyze_stair_kinematics(R_foot_angle_data,R_shank_angle_data,...
                ...
                R_HS,...
                treadmill_speed, treadmill_incline, stride_count_master, R_stair_events, RIGHT_LEG_NUM, SAMPLE_RATE_VICON_NOMINAL);
