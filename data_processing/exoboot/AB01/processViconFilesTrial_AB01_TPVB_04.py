...
if __name__ == '__main__':
	...
	filename = 'FootMarkers EKFTPV4B 04.csv'

	AB_SUBJECT = 'AB01'

	# Load in HS data
	nrows_HS = 245 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 80435# row num that contains AB0's:
	...
	nrows = 8018 #=  num frames, alsolast idx - row with frame subframe
