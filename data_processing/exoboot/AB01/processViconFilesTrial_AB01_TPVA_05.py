...
if __name__ == '__main__':
	...
	filename = 'FootMarkers EKFTPV4A 05.csv'
	...
	# MARKER
	n_skiprows_marker_1 = 80263# row num that contains AB0's:
	...
	nrows = 8001 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPVA_05_processed.csv',index=False)
