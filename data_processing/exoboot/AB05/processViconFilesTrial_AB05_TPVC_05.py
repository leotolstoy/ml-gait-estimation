...
if __name__ == '__main__':
	...
	filename = 'AB05_FootMarkers_EKFTPV4C_05.csv'

	AB_SUBJECT = 'AB05'

	# Load in HS data
	nrows_HS = 249 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 80709# row num that contains AB0's:
	...
	nrows = 8045 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPVC_05_processed.csv',index=False)
