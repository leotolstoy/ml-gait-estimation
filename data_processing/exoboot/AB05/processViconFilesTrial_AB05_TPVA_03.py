...
if __name__ == '__main__':
	...
	filename = 'AB05_FootMarkers_EKFTPV4A_03.csv'

	AB_SUBJECT = 'AB05'

	# Load in HS data
	nrows_HS = 235 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 81325# row num that contains AB0's:
	...
	nrows = 8108 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPVA_03_processed.csv',index=False)
