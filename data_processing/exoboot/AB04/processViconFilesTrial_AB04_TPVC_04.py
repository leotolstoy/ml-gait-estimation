...
if __name__ == '__main__':
	...
	# MARKER
	n_skiprows_marker_1 = 81021# row num that contains AB0's:
	...
	nrows = 8073 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPVC_04_processed.csv',index=False)
