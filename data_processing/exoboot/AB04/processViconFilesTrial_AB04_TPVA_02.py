...
if __name__ == '__main__':
	...
	filename = 'AB04_EKF_TPVA_02.csv'

	AB_SUBJECT = 'AB04'

	# Load in HS data
	nrows_HS = 275 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 81145# row num that contains AB0's:
	...
	nrows = 8086 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPVA_02_processed.csv',index=False)
