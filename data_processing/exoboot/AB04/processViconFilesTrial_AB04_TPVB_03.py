...
if __name__ == '__main__':
	...
	# MARKER
	n_skiprows_marker_1 = 81213# row num that contains AB0's:
	...
	nrows = 8094 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPVB_03_processed.csv',index=False)
