...
if __name__ == '__main__':
	...
	filename = 'AB08_EKF_TPVC_03.csv'

	AB_SUBJECT = 'AB08'

	# Load in HS data
	nrows_HS = 285 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 81255# row num that contains AB0's:
	...
	nrows = 8096 #=  num frames, alsolast idx - row with frame subframe
