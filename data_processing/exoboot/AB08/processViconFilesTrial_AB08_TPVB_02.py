...
if __name__ == '__main__':
	...
	filename = 'AB08_EKF_TPVB_02.csv'

	AB_SUBJECT = 'AB08'

	# Load in HS data
	nrows_HS = 248 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 78488# row num that contains AB0's:
	...
	nrows = 8088 #=  num frames, alsolast idx - row with frame subframe
	...
	for i, HS in enumerate(HSs):
		...
		prevHS_idx = HS_idx + 1
		if prevHS_idx >= len(time_vicon):
			prevHS_idx = len(time_vicon) - 1
