...
if __name__ == '__main__':
	...
	filename = 'AB02_EKF_TPVA_01.csv'

	AB_SUBJECT = 'AB02'

	# Load in HS data
	nrows_HS = 241 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 80761# row num that contains AB0's:
	...
	nrows = 8051 #=  num frames, alsolast idx - row with frame subframe
