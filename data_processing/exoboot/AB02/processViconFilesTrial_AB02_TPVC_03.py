...
if __name__ == '__main__':
	...
	filename = 'AB02_EKF_TPVC_03.csv'

	AB_SUBJECT = 'AB02'

	# Load in HS data
	nrows_HS = 251 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 80741# row num that contains AB0's:
	...
	nrows = 8048 #=  num frames, alsolast idx - row with frame subframe
