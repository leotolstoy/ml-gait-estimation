...
if __name__ == '__main__':
	...
	filename = 'AB10_EKF_TPVA_04.csv'

	AB_SUBJECT = 'AB10'

	# Load in HS data
	nrows_HS = 255 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 81215# row num that contains AB0's:
	...
	nrows = 8095 #=  num frames, alsolast idx - row with frame subframe
	...
	for i, HS in enumerate(HSs):
		...
		if i == 0:
			...
			speedIdx = np.min([speedIdx,len(speeds)-1])
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPVA_04_processed.csv',index=False)
