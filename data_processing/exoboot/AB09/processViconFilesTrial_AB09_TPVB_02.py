...
if __name__ == '__main__':
	...
	filename = 'AB09_EKF_TPVB_02.csv'

	AB_SUBJECT = 'AB09'

	# Load in HS data
	nrows_HS = 279 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 81219# row num that contains AB0's:
	...
	nrows = 8093 #=  num frames, alsolast idx - row with frame subframe
