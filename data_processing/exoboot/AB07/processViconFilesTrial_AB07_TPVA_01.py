...
if __name__ == '__main__':
	...
	filename = 'AB07_EKF_TPVA_01.csv'

	AB_SUBJECT = 'AB07'

	# Load in HS data
	nrows_HS = 253 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 81863# row num that contains AB0's:
	...
	nrows = 8147 #=  num frames, alsolast idx - row with frame subframe
