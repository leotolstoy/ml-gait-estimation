...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230206-21_AB12-Brake-walkingcircuitpilot_seg1.csv'
    vicon_filename = 'Vicon_Pilot-AB12-Brake_walkingcircuitpilot1-seg1_processed.csv'
    export_filename = 'exoboot_Vicon_AB12-Brake_walkingcircuitpilot_seg1.csv'

    time_vicon_offset = 0.295
