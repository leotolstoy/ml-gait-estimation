...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230206-21_AB12-Brake-stairspilot1.csv'
    vicon_filename = 'Vicon_Pilot-AB12-Brake_stairspilot1_processed.csv'
    export_filename = 'exoboot_Vicon_AB12-Brake_pilotstairs.csv'

    time_vicon_offset = 0.247
