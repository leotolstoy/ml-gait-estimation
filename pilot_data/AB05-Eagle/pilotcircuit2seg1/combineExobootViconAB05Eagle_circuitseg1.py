...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230214-21_AB05-Eagle-pilotcircuit2_seg1.csv'
    vicon_filename = 'Vicon_Pilot-AB05-Eagle_Pilot_circuit_2_seg1_processed.csv'
    export_filename = 'exoboot_Vicon_Pilot-AB05-Eagle_Pilot_circuit_2_seg1_processed.csv'

    time_vicon_offset = -1.068
