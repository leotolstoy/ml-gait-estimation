...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230206-19_AB05-Eagle-pilotwalkingcircuit2_seg1.csv'
    vicon_filename = 'Vicon_AB05-Eagle_pilotwalkingcircuitseg1_processed.csv'
    export_filename = 'exoboot_Vicon_AB05-Eagle_pilotwalkingcircuitseg1.csv'

    time_vicon_offset = 0.277
