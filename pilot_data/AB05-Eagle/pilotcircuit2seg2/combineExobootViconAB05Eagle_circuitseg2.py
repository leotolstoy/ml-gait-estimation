...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230214-21_AB05-Eagle-pilotcircuit2_seg2.csv'
    vicon_filename = 'Vicon_Pilot-AB05-Eagle_Pilot_circuit2_seg2_processed.csv'
    export_filename = 'exoboot_Vicon_Pilot-AB05-Eagle_Pilot_circuit2_seg2_processed.csv'

    time_vicon_offset = -17.596
