...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230215-16_AB04-Kronecker-pilotcircuitseg3.csv'
    vicon_filename = 'Vicon_AB04-Kronecker_pilotcircuitseg3_processed.csv'
    export_filename = 'exoboot_Vicon_AB04-Kronecker_pilotcircuitseg3_processed.csv'

    time_vicon_offset = -7.9
