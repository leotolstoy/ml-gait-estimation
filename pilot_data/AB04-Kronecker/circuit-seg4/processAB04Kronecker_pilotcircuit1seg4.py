...
if __name__ == '__main__':
    ...
    filename = 'pilotcircuitseg4.csv'

    AB_SUBJECT = 'AB04-Kronecker'

    # Load in HS data
    nrows_events = 20 #row number of the last HS row
    n_skiprows_marker_1 = 24# row num that contains AB0's:
    nrows = 2789 #=  num frames, alsolast idx - row with frame subframe
