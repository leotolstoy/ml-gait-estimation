...
if __name__ == '__main__':
    ...
    exoboot_filename = '20230215-16_AB04-Kronecker-pilotcircuitseg1.csv'
    vicon_filename = 'Vicon_AB04-Kronecker_pilotcircuitseg1_processed.csv'
    export_filename = 'exoboot_Vicon_AB04-Kronecker_pilotcircuit1seg1_processed.csv'

    time_vicon_offset = -3.859
